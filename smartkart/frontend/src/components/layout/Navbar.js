    ...
    <nav className="navbar">
      <div className="navbar-container">
        ...
        <div className="nav-links">
          ...
          {!isCustomerDashboardOrProfile && <Link to="/dashboard" className="nav-link">Products</Link>}
          {!isCustomerDashboardOrProfile && <Link to="/profile" className="nav-link">Orders</Link>}
        </div>
